 ...
 * 
 * Provides a very simple color form field with a ColorMenu dropdown. Values are
 * stored as a six-character hex value without the '#' (i.e., 'FFFFFF').
 * 
 ...
 */
Ext.ux.ColorField = Ext.extend(function(config){
     ...
     * True to display the HTML Hexidecimal Color Value in the field so it is
     * manually editable.
     */
    showHexValue : false,
     ...
     * will always get the class 'x-form-trigger' and triggerClass will be
     * <b>appended</b> if specified (defaults to 'x-form-color-trigger' which
...
triggerClass : 'go-form-color-trigger',
     ...
     * A string to be displayed when the length of the input field is not 3 or
     * 6, i.e. 'fff' or 'ffccff'.
     */
...
return this.curValue || this.defaultValue || "FFFFFF";
    ...
    /**
     * Sets the value of the color field. Format as hex value 'FFFFFF' without
     * the '#'.
