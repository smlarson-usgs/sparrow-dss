...
if(Sarissa._SARISSA_IS_IE){
    ...
    XSLTProcessor.prototype.transformToDocument = function(sourceDoc){
        ...
        if(_SARISSA_THREADEDDOM_PROGID){
//            if (sourceDoc.xml) {
//                sourceDoc = $.xmlDOM(sourceDoc.xml);
//            }
...
/*
 * A fix for an issue in IE9.  This is added by ee on 1/26/2012 per this discussion:
 * http://sourceforge.net/tracker/?func=detail&aid=3412894&group_id=75155&atid=543074
 */
...
if (!window.XMLSerializer.serializeToString && Sarissa.getDomDocument
			&& Sarissa.getDomDocument("", "foo", null).xml) {
	/**
