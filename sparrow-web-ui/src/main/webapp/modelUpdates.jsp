...
<head>
    ...
    <title>SPARROW DSS - Model Updates</title>
...
<div id="page-content" class="area-1 area"> 
	<div id="faq-container" class="area-content">
		...
		<h1>Model Updates for the SPARROW DSS Tool</h1>

		<%= AtomReaderUtil.getAtomFeedContentOnlyAsString("https://my.usgs.gov/confluence/createrssfeed.action?types=page&spaces=conf_all&title=SPARROW_DSS_MODEL_UPDATES&labelString=sparrow_dss_model_updates&excludedSpaceKeys=&sort=modified&maxResults=1&timeSpan=3650&showContent=true") %>
	</div>
</div>
