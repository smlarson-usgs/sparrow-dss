...
public class CalcBinningTest extends SparrowTestBase {
	...
	////////////////////////////////////
	//
	//All tests hitting the old binning implementation - maybe worth porting??
...
//
//		BigDecimal[] result = OldCalcBinning.buildEqualCountBins(data, 0, binCount, true, true);
...
//				binCount + 1, expectedBins.length);
//
//		BigDecimal[] result = OldCalcBinning.buildEqualCountBins(sorted, binCount, round);
