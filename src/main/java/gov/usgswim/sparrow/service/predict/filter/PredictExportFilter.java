...
public class PredictExportFilter implements RowFilter {
    ...
    public PredictExportFilter(PredictionContext context, String bbox) throws Exception {
        this.results = getResults(context, bbox);
    }
     ...
     *         bounding box.
     */
    private ResultSet getResults(PredictionContext context, String bounds) throws Exception {
        ...
        String query = ""
                ...
                + "WHERE "
                + "  A.sparrow_model_id = " + context.getModelID()
