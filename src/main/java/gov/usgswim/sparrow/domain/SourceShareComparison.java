...
public class SourceShareComparison extends Comparison {
	...
	public static final String MAIN_ELEMENT_NAME = "sourceShareComparison";
	...
	public SourceShareComparison() {};

	public SourceShareComparison parse(XMLStreamReader in) throws XMLStreamException, XMLParseValidationException {
	...
	public boolean equals(Object obj) {
		if (obj instanceof SourceShareComparison) {
