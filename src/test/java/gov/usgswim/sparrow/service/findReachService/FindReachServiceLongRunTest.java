...
public class FindReachServiceLongRunTest extends
		SparrowServiceTestBaseWithDBandCannedModel50 {
	 ...
	 */
	@Test
	public void OverTheLimitNumberOfReachesReturned() throws IOException,
		...
		assertXpathEvaluatesTo("50",
				"/*[local-name()='sparrow-reach-response']/@model-id",
				actualResponse);
		assertXpathEvaluatesTo("50", "count(//*[local-name()='reach'])",
				actualResponse);
		assertXpathEvaluatesTo(
				ReturnStatus.OK.toString(),
				"/*[local-name()='sparrow-reach-response']/*[local-name()='status']",
				actualResponse);
	}
	 ...
	 */
	@Test
	public void MultipleEDANames() throws IOException, SAXException,
			XpathException {
		...
		assertXpathEvaluatesTo("50",
				"/*[local-name()='sparrow-reach-response']/@model-id",
				actualResponse);
		assertXpathEvaluatesTo("OK", "//*[local-name()='status']",
				actualResponse);
		assertXpathEvaluatesTo("4909",
				"(//*[local-name() = 'id' ])[position() = 1]", actualResponse);
		assertXpathEvaluatesTo("4911",
				"(//*[local-name() = 'id' ])[position() = 2]", actualResponse);
		assertXpathEvaluatesTo("4832",
				"(//*[local-name() = 'id' ])[position() = 3]", actualResponse);
		assertXpathEvaluatesTo("4854",
				"(//*[local-name() = 'id' ])[position() = 4]", actualResponse);
	}
