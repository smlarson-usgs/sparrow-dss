...
public class SparrowModelFlatteningFormatter  extends AbstractFormatter {
	public static List<String> modelAttributes = Arrays.asList(new String[] {"id", "name", "description", "dateAdded", "contactID", "ehnNetworkId", "north", "west", "south", "east"});

	private class Model{
		public String id, name, description, dateAdded, contactID, ehnNetworkId, north, west, south, east;
		
		public boolean isModelAtt(String name) {
			return modelAttributes.contains(name);
		}
//		<model id="1">
//		<name>Chesapeake bay</name>
//		<description>Chesapeake bay Test Model</description>
//		<dateAdded>2007-03-22</dateAdded>
//		<contactId>21</contactId>
//		<enhNetworkId>1</enhNetworkId>
//		<bounds north="41.019231" west="-80.922115" south="36.519231" east="-74.172115"/>
	}
...
//	private String itemValue;
	...
	public SparrowModelFlatteningFormatter(OutputType type) {
		super(type);
		switch (type) {
