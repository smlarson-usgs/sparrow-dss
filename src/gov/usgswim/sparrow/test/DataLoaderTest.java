...
//	
	 ...
	 */
	public void testLoadMinimalPredictDataSetOld() throws Exception {
		...
		DataTableCompareOld comp = buildPredictionComparisonOld(result);
	...
	protected DataTableCompareOld buildPredictionComparisonOld(DataTable toBeCompared) throws Exception {
