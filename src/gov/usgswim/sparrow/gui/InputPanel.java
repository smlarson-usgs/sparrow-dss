...
public class InputPanel extends JPanel {
	...
	private FileChooserPanel ancilPanel = new FileChooserPanel(SparrowData.DATA_TYPE_ANCIL, "Ancillary Values File (ancil.txt - not required)", "Anicillary Values (predict.txt)");
