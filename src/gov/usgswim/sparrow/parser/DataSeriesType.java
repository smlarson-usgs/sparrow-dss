...
public enum DataSeriesType {
	total											(true, false, false, 1, false, false),
	incremental								(true, false, false, 1, false, false),
	total_no_decay						(true, false, false, 1, false, true),
	total_delivered						(true, false, true, 1, true, false),
	total_decay								(true, false, false, 1, false, true),
	incremental_delivered			(true, false, true, 1, true, false),
	delivered_fraction				(false, false, true, 0, true, false),
	source_value							(false, true, false, 2, false, false),
	land_to_water_coef				(false, false, true, 2, false, false),
	instream_decay_coef				(false, false, true, 0, false, false);
	...
	DataSeriesType(boolean resultBased, boolean sourceBased, boolean coefBased, 
			int srcRequirement, boolean targetRequired, boolean extraColumn) {
	...
	/**
	 * Returns trie if this dataseries does not allow a source to be specified.
