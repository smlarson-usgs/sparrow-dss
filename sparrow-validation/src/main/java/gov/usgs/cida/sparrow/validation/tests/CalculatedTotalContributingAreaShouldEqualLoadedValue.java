 ...
 * @author cschroed
 */
public class CalculatedTotalContributingAreaShouldEqualLoadedValue extends CalculatedAreaShouldEqualLoadedValue {
	public CalculatedTotalContributingAreaShouldEqualLoadedValue(
			Comparator comparator,
			Comparator shoreReachComparator,
			boolean failedTestIsOnlyAWarning) {
		super(comparator, shoreReachComparator, failedTestIsOnlyAWarning, AreaType.TOTAL_CONTRIBUTING);
	}
