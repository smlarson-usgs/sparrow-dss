...
public class TotalContributingAreaCalculator extends SparrowCalculatorBase {
	...
	/** If true, IfTran is ignored for calculating upstream reaches.  Having this false really is the definition of 'contributing' area. */
	private final boolean forceIgnoreIfTran = false;
