 ...
 * @author eeverman
 */
public class RunWatershedAreaTestWithoutIftran extends SparrowModelValidationRunner {

	public static void main(String[] args) throws Exception {
		String myClassName = RunWatershedAreaTestWithoutIftran.class.getCanonicalName();
