...
public class NamingConventionsTest {
	 ...
	 public void trySomeSimpleConvertionsToXMLSafeValues() {
		...
		//assertEquals("50P0", NamingConventions.convertContextIdToXMLSafeName(50, 0));
                assertEquals("postgres-sparrow-catchment-reusable:catch_123456789", NamingConventions.getPostgresFullCatchmentLayerName(00, 123456789, true));
		...
		assertEquals("postgres-sparrow-catchment:catch_-123456789", NamingConventions.getPostgresFullCatchmentLayerName(00, -123456789, false));
