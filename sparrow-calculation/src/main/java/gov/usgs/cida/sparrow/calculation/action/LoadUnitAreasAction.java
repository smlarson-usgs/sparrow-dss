package gov.usgs.cida.sparrow.calculation.action;
 ...
 * @author eeverman
 */
public class LoadUnitAreasAction extends Action<DataTable> {

	protected long modelId;
	protected Area area = Area.NONE;	//Default to individual reaches
	...
	public LoadUnitAreasAction(long modelId, Area hucLevel, boolean cumulative) {
		super();
	...
	public DataTable doAction() throws Exception {
		...
		message.append("Loaded UnitAreas for " + modelId + " HucLevel " + area + " cumulative " + cumulative + NL);
