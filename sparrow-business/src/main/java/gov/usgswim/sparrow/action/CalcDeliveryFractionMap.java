...
public class CalcDeliveryFractionMap extends Action<ReachRowValueMap> {
	...
	protected PredictData predictData; //the predictData used to calc the delivery fraction.
	protected Collection<Long> targetReachIds; //The targets to calc the delivery fraction w/ respect to.
	protected String msg = null;

	/**
	 * @param predictData the predictData used to calc the delivery fraction.
	 * @param targetReachIds The targets to calc the delivery fraction w/ respect to.
	 */
	public CalcDeliveryFractionMap(PredictData predictData, Collection<Long> targetReachIds) {
	...
	protected HashMap<Integer, DeliveryReach> calcDeliveryHash(
			PredictData predictData, Collection<Long> targetReachIds) throws Exception {
