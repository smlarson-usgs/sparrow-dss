...
alter table model_reach_attrib_swap disable constraint model_rch_attrib_swp_model_fk;
alter table model_reach_watershed disable constraint model_reach_id_fk;    

alter table source_reach_coef_swap disable constraint source_reach_coef_swp_src_fk; 
alter table source_value_swap disable constraint source_value_swp_source_fk;
