...
<html>
	...
	<body>
		...
		<form method="post" action="../sp_findReach/formpost" enctype="application/x-www-form-urlencoded">
			<fieldset>
				<legend><b>Find Reach (POST)</b></legend>

				<textarea id="xml_input_1" name="xmlreq" cols="120" rows="20">
<sparrow-reach-request xmlns="http://www.usgs.gov/sparrow/id-point-request/v0_2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<model-id>50</model-id>
	<match-query>
		<reach-ids></reach-ids>
		<reach-name>OGEE</reach-name>
		<meanQHi>60</meanQHi>
		<meanQLo>30</meanQLo>
		<catch-area-hi>90</catch-area-hi>
		<catch-area-lo>75</catch-area-lo>
		<huc>03060</huc>
		<edaname>Ossa</edaname>
		<edacode>S130x</edacode>
		<!-- bbox>-90.966796875,40.45440673828125,-89.34906005859375,41.00372314453125</bbox>  -->
	</match-query>
	<content>
		<adjustments/>
	</content>
