...
/**
 * Loads the distinct EDA Codes for a model.
 * 
 ...
 * @author eeverman
 */
public class LoadEDACodeColumn extends Action<ColumnData> {
	...
	public LoadEDACodeColumn(long modelId) {
		super();
		this.modelId = modelId;
	}


	public LoadEDACodeColumn() {
		super();
	}
