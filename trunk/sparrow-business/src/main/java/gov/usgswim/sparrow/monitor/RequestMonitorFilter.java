...
public class RequestMonitorFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (debug) {
			log("RequestMonitorFilter:doFilter()");
		}

		RequestMonitor monitor = null;
		if (request instanceof HttpServletRequest) {
			HttpServletRequest httpReq = (HttpServletRequest) request;
			monitor = new RequestMonitor(httpReq.getRequestURL().toString());
		} else {
			monitor = new RequestMonitor("Non-HTTP-Request");
		}
		
		SharedApplication.getInstance().addActiveRequest(monitor);
		monitor.start();
		...
		monitor.finish();
		SharedApplication.getInstance().setRequestFinished(monitor);
	...
	public void init(FilterConfig filterConfig) {		
		...
		if (filterConfig != null) {
			if (debug) {				
				log("RequestMonitorFilter: Initializing filter");
			}
		}
	}
	...
	public String toString() {
		...
		StringBuffer sb = new StringBuffer("RequestMonitorFilter(");
	...
	class RequestWrapper extends HttpServletRequestWrapper {
		...
		public void setParameter(String name, String[] values) {
			if (debug) {
				System.out.println("RequestMonitorFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
			}
		...
		public String getParameter(String name) {
			if (debug) {
				System.out.println("RequestMonitorFilter::getParameter(" + name + ") localParams = " + localParams);
			}
			if (localParams == null) {
		...
		public String[] getParameterValues(String name) {
			if (debug) {
				System.out.println("RequestMonitorFilter::getParameterValues(" + name + ") localParams = " + localParams);
			}
			if (localParams == null) {
		...
		public Enumeration getParameterNames() {
			if (debug) {
				System.out.println("RequestMonitorFilter::getParameterNames() localParams = " + localParams);
			}
			if (localParams == null) {
		...
		public Map getParameterMap() {
			if (debug) {
				System.out.println("RequestMonitorFilter::getParameterMap() localParams = " + localParams);
			}
			if (localParams == null) {
	...
	/*
		 ...
		 * cookies locally as well as in the wrapped response. public void addCookie
		 * (Cookie cookie) { if (cookies == null) cookies = new Vector();
		 * cookies.add(cookie);
