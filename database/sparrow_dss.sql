...
CREATE OR REPLACE VIEW SPARROW_DSS.MODEL_UPSTREAM_VW AS 
SELECT downstream.SPARROW_MODEL_ID SPARROW_MODEL_ID, downstream.identifier DOWNSTREAM_ID, upstream.identifier UPSTREAM_ID
FROM
